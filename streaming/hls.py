...
if __name__ == "__main__":
    """
    ### Command to run
    python hls.py - i "/Volumes/WorkCorner/Aalto-SchoolWork/Spring_2022/ELEC-E7320_Internet_Protocols/internet-proto-py/resources/raw_videos/360demo.mp4" - o "/Volumes/WorkCorner/Aalto-SchoolWork/Spring_2022/ELEC-E7320_Internet_Protocols/internet-proto-py/resources/stream/360demo.m3u8"
    """
    sys.exit(main())
